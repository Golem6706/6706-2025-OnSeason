...
public class ThreeCoralShort implements Auto {
    ...
    public static final Time WAIT_FOR_SUPER_STRUCTURE_TIMEOUT = Seconds.of(2.0);
    ...
    private static Command runRobotBackwardsSlow(RobotContainer robot) {
        return robot.drive
                .run(() -> robot.drive.runRobotCentricChassisSpeeds(new ChassisSpeeds(-0.2, 0, 0)))
                .asProxy();
    }
    ...
    public Pose2d getStartingPoseAtBlueAlliance() {
        Pose2d poseAtLeft = new Pose2d(7.1, 5.8, Rotation2d.fromDegrees(-135));
